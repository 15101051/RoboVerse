from robomimic.algo import BC_RNN
from robomimic.config import BCConfig
import robomimic.utils.obs_utils as ObsUtils
from diffusion_policy.common.robomimic_config_util import get_robomimic_config_bc_rnn_baseline_modified


class BCRNN(BC_RNN):
    """
    BCRNN wrapper for robomimic BC_RNN
    ...
    def __init__(self, shape_meta, action_dim, action_horizon, device):
        ...
        config: BCConfig = get_robomimic_config_bc_rnn_baseline_modified()
